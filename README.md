...
**Canonical public portfolio:** [drew-burt-portfolio.dburt30.chatgpt.site](https://drew-burt-portfolio.daxxer-os.chatgpt.site)
...
| --- | --- | --- |
| Public positioning, navigation, assessment, lab, and contact paths | [ChatGPT Sites portfolio](https://drew-burt-portfolio.daxxer-os.chatgpt.site) | The current visitor-facing experience |
...
The two portfolio builds are not maintained as competing websites. The GitHub Pages root hands visitors to the Sites portfolio. Existing technical briefs remain available as supporting evidence.
...
- [Assessment](https://drew-burt-portfolio.daxxer-os.chatgpt.site/assess) — 12-control governance diagnostic
- [Agentic Readiness Audit](https://drew-burt-portfolio.daxxer-os.chatgpt.site/agentic-readiness-audit) — $1,250 founding-pilot assessment for one AI-enabled workflow, with explicit delivery and authority boundaries
- [Governance Lab](https://drew-burt-portfolio.daxxer-os.chatgpt.site/lab) — simulated execution-control scenarios
- [Systems](https://drew-burt-portfolio.daxxer-os.chatgpt.site/systems) — plain-language claims linked to public evidence
- [Work Log](https://drew-burt-portfolio.daxxer-os.chatgpt.site/work-log) — review-gated morning directives, build receipts, decisions, and field notes
- [Work with Drew](https://drew-burt-portfolio.daxxer-os.chatgpt.site/work-with-me) — roles, scoped work, and partnerships

## Featured systems

- [Operator Intelligence](https://github.com/dburt-proex/operator-intelligence) — evidence-backed assessment, scoring, findings, and implementation routing.
- [CASA](https://github.com/dburt-proex/CASA-Flagship) — deterministic runtime governance with ALLOW, REVIEW, and HALT gates.
- [DiffWall](https://github.com/dburt-proex/diffwall) — deterministic risk controls for agent-authored changes.
- [PromptBP](https://github.com/dburt-proex/PromptBP) — instruction-control architecture with explicit output and validation boundaries.
- [Verified Intelligence Layer](https://github.com/dburt-proex/VIL_deterministic_scoring_engine) — evidence-capped scoring and decision routing.

## Supporting evidence

- [Agentic Readiness Audit](https://drew-burt-portfolio.daxxer-os.chatgpt.site/agentic-readiness-audit) — founding-pilot scope, price, delivery package, and assessment boundary.
...
2. Update this repository when the evidence map, maturity boundary, or public claim changes.
3. Update ChatGPT Sites when visitor-facing wording or functionality changes.
4. Check that public links resolve to the documented evidence.
